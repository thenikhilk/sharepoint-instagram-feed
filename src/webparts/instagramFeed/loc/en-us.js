define([], function () {
  return {
    "DefaultUsername": "thenikhilk",
    "PropertyPaneDescription": "Configure WebPart properties to embed user feed on the page.",
    "BasicGroupName": "Settings",
    "UsernameFieldLabel": "Username",
    "ShowAliasToggleLabel": "Show user avatar?",
    "ShowAliasToggleTrueLabel": "Yes",
